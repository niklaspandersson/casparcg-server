    ...
    , public IDeckLinkVideoFrameMetadataExtensions
{
  ...
  public:
    ...
    decklink_frame(core::video_format_desc       format_desc,
        ...
        , data_(allocate_frame_data(format_desc_, pix_fmt_))
        , nb_samples_(nb_samples)
        , hdr_(hdr)
        , color_space_(color_space)
        , hdr_metadata_(hdr_metadata)
    ...
    long STDMETHODCALLTYPE GetRowBytes() override { return static_cast<long>(get_row_bytes(pix_fmt_, format_desc_.width)); }
...
struct decklink_secondary_port final : public IDeckLinkVideoOutputCallback
{
    ...
    {
        auto packed_frame = wrap_raw<com_ptr, IDeckLinkVideoFrame>(new decklink_frame(decklink_format_desc_, 
                                                                                      nb_samples, 
                                                                                      config_.hdr, 
