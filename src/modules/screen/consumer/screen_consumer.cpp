            ...
            try {
                ...
                for (int n = 0; n < 2; ++n) {
                    ...
                    GL(glTextureStorage2D(frame.tex,
                                          1,
                                          config_.high_bitdeph ? GL_RGBA16 : GL_RGBA8,
                                          format_desc_.width,
                                          format_desc_.height));
                    GL(glClearTexImage(
                        frame.tex, 0, GL_BGRA, config_.high_bitdeph ? GL_UNSIGNED_SHORT : GL_UNSIGNED_BYTE, nullptr));
    ...
    void tick()
    {
        ...
        // Upload
        {
            ...
            GL(glTextureSubImage2D(frame.tex,
                                   ...
                                   format_desc_.height,
                                   GL_BGRA,
                                   config_.high_bitdeph ? GL_UNSIGNED_SHORT : GL_UNSIGNED_BYTE,
                                   nullptr));
